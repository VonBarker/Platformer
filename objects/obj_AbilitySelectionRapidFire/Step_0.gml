if(position_meeting(mouse_x, mouse_y, obj_AbilitySelectionRapidFire) && mouse_check_button(mb_left) && obj_Game.rapidFireUnlocked = true && !obj_AbilitySelectionMenu.abilitySelected)
{
	x = mouse_x - 40;
	y = mouse_y - 40;
